            ...
            <div className='flex justify-between gap-12 w-full max-w-screen-xl'>
                <div className='w-[40%] flex flex-col gap-8'>
                    ...
                    <div className='border py-6 px-6 rounded-lg flex flex-col gap-6'>
                        <h6 className='text-xl'>What are you looking for?</h6>
                ...
                <div className='w-[48%] flex justify-end rounded-lg overflow-hidden'>
                    <Image className='w-auto h-full object-cover' width={100} height={100} src={"https://res.cloudinary.com/urbanclap/image/upload/t_high_res_template,q_auto:low,f_auto/dpr_2,fl_progressive:steep,q_auto:low,f_auto,c_limit/images/growth/home-screen/1696852847761-574450.jpeg"}/>
                </div>
            </div>
        </div>
    );
